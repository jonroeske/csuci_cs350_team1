...
from Libraries.faker.config import AVAILABLE_LOCALES
from Libraries.faker.config import PROVIDERS as STANDARD_PROVIDER_NAMES
from Libraries.faker.providers import BaseProvider
